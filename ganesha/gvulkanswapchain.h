...
private:
    ...
    void createSwapChain(const TUInt screenWidth, const TUInt screenHeight, const TBool shouldCreateRenderPass, VkSurfaceKHR& surface, GVULKANDevice& vulkanDevice);
