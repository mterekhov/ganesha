...
GSceneNode::GSceneNode(std::shared_ptr<GMesh> mesh, const GVector& newTranslation, const GVector& newRotation, const GVector& newScale, std::shared_ptr<GVULKANImage> newMaterial) :
mesh(mesh),
