...
TCharPointersArray GVULKANInstance::collectValidationLayers(const TCharPointersArray& layersNamesList) {
    uint32_t layerCount;
...
TInstanceExtensionsArray GVULKANInstance::collectInstanceExtensions() {
